...
<head>
    ...
    <meta name="description" content="{{ $description ?? 'Professionele gastouderopvang voor kinderen van 0-4 jaar in Capelle aan den IJssel, wijk Schollevaar. Kleinschalige, huiselijke opvang met ervaren gastouder.' }}">
    ...
    <meta property="og:description" content="{{ $description ?? 'Professionele gastouderopvang voor kinderen van 0-4 jaar in Capelle aan den IJssel, wijk Schollevaar. Kleinschalige, huiselijke opvang met ervaren gastouder.' }}">
    ...
    <meta property="business:contact_data:phone_number" content="+31-6-11313969">
    ...
    <meta name="twitter:description" content="{{ $description ?? 'Professionele gastouderopvang voor kinderen van 0-4 jaar in Capelle aan den IJssel, wijk Schollevaar.' }}">
...
<body>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Professionele gastouderopvang voor kinderen van 0-4 jaar in Capelle aan den IJssel, wijk Schollevaar. Kleinschalige, huiselijke opvang met ervaren gastouder.",
        "url": "{{ url('/') }}",
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        "@@type": "Service",
                        "name": "Dagopvang",
                        "description": "Volledige dagopvang in een warme, huiselijke omgeving voor kinderen van 0-4 jaar"
                    }
                },
                {
                    "@@type": "Offer",
